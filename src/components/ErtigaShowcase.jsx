import './ErtigaShowcase.css'

export default function ErtigaShowcase() {
  return (
    <section className="ertiga-showcase" id="ertiga">
      ...
      <div className="section-header">
        <h2 className="model-name">SUZUKI ERTIGA</h2>
