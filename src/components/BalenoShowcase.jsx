import './BalenoShowcase.css'

export default function BalenoShowcase() {
  return (
    <section className="baleno-showcase" id="baleno">
      ...
      <div className="section-header">
        <h2 className="model-name">MARUTI BALENO</h2>
