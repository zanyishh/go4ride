import './MagniteShowcase.css'

export default function MagniteShowcase() {
  return (
    <section className="magnite-showcase" id="magnite">
      ...
      <div className="showcase-container">
        ...
        <div className="car-showcase">
          <img 
            src="/cars/magnite.png" 
            alt="Nissan Magnite" 
            className="magnite-image"
          />
