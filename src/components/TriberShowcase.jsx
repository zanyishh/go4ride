import './TriberShowcase.css'

export default function TriberShowcase() {
  return (
    <section className="triber-showcase" id="triber">
      ...
      <div className="section-header">
        <h2 className="model-name">RENAULT TRIBER</h2>
